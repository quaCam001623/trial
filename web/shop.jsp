<%-- 
    Document   : shop
    Created on : Feb 27, 2024, 9:08:44 PM
    Author     : NGUYEN LAN
--%>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <form action="shop" method="post">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Search by name" name="s" value="${searchByName}">
                    ...
                    <c:forEach items = "${listP}" var="p">
                        ...
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3"><a href="detail?pID=${p.getId()}" style="color: black;">${p.getName()}</a></h6>
...
<!--                            <li class="page-item active"><a class="page-link" href="#">1</a></li>
                          ...
                          <c:forEach begin="1" end="${endP}" var="e">
                              <li class="page-item ${numP==e?"active":""}"><a class="page-link" href="shop?numberOfPage=${e}" >${e}</a></li>
                          </c:forEach>
                            <li class="page-item">
